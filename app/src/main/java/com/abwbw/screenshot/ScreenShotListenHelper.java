...
public class ScreenShotListenHelper {

    private static final String TAG = "ScreenShotListenHelper";
    ...
    private static final String[] KEYWORDS = {
            ...
            "screencap", "screen_cap", "screen-cap", "screen cap", "截图", "截屏"
    };
    ...
    private ScreenShotListenHelper(Context context) {
        if (context == null) {
    ...
    public static ScreenShotListenHelper newInstance(Context context) {
        assertInMainThread();
        return new ScreenShotListenHelper(context);
    }
